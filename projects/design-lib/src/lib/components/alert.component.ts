      ...
      <div *ngIf="showIcon" class="flex items-start">
        <div class="flex-shrink-0">
          <div [ngClass]="iconColor">
            ...
            <svg *ngIf="type === 'danger'" class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="ml-3 flex-1">
          <h3 *ngIf="title" class="text-sm font-medium" [ngClass]="textColor">{{ title }}</h3>
