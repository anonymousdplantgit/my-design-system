  ...
  template: `
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2">
        <select *ngIf="showPageSizeOptions"
      ...
      <div class="flex items-center space-x-1">
        ...
        <button class="relative inline-flex items-center px-2 py-1 border border-neutral-300 bg-white text-sm font-medium text-neutral-500 hover:bg-neutral-50 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                [disabled]="currentPage === 1"
                [ngClass]="currentPage === 1 ? 'opacity-50 cursor-not-allowed' : ''"
        ...
        <span
          *ngFor="let page of visiblePages"
          ...
          [ngClass]="page === currentPage ? 'bg-primary-500 text-white border-primary-500' : 'bg-white text-neutral-500 border-neutral-300 hover:bg-neutral-50 cursor-pointer'"
          (click)="goToPage(page)">
          {{ page }}
        </span>
