...
@Component({
  ...
  template: `
    <div
      *ngIf="isOpen"
      class="fixed inset-0 z-50 overflow-auto bg-neutral-800 bg-opacity-75 flex items-center justify-center"
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  get sizeClass(): string {
    switch (this.size) {
      ...
      case 'full':
        return 'max-w-full m-5 w-full';
      default:
        return 'max-w-lg w-full'; // md
    }
  }
