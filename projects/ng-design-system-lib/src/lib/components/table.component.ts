...
@Component({
  ...
  template: `
    <div [ngClass]="wrapperClass" class="relative">
          ...
          <thead>
            <tr>
              ...
              >
                ...
                <ng-container
                  *ngIf="col.headerTemplate; else defaultHeaderTemplate"
                >
                  <ng-container
                    *ngTemplateOutlet="
                      col.headerTemplate;
                ...
                <ng-template #defaultHeaderTemplate>
                  <div class="flex items-center">
                    ...
                    <span *ngIf="col.sortable" class="ml-1">
                      ...
                      <svg
                        *ngIf="sortField === col.field && sortOrder === 'asc'"
                      ...
                      <svg
                        *ngIf="sortField === col.field && sortOrder === 'desc'"
                        class="h-4 w-4 text-primary-500"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
                        fill="currentColor"
          ...
          <tbody>
            <tr *ngIf="loading || filteredData.length === 0">
              <td [attr.colspan]="columns.length" class="text-center py-4">
                ...
                <span *ngIf="!loading && filteredData.length === 0"
            ...
            <ng-container *ngIf="!loading && filteredData.length > 0">
              ...
              >
                <td *ngFor="let col of columns" [ngClass]="getCellClasses(col)">
                  ...
                  <ng-container
                    *ngIf="col.cellTemplate; else defaultCellTemplate"
                  >
                    <ng-container
                      *ngTemplateOutlet="
                        col.cellTemplate;
                        context: { $implicit: row, rowData: row, column: col }
                      "
                    ></ng-container>
                  </ng-container>
      ...
      <!-- Pagination -->
      <div
        *ngIf="paginated && filteredData.length > 0"
...
export class TableComponent<T = any> implements AfterContentInit {
  ...
  columnComponents!: QueryList<TableColumnComponent>;

  @Input() data: T[] = [];
  @Input() loading: boolean = false;
  @Input() wrapperClass: string = '';
  @Input() tableClass: string =
    'min-w-full divide-y divide-neutral-200 border-collapse';
