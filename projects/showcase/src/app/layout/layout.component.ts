...
import {AvatarComponent, ButtonComponent} from 'ng-design-system-lib';
            ...
            <ng-template #defaultMenu>
              <div
                *ngFor="let item of menuItems"
                [ngClass]="{ 'border-t border-neutral-200 pt-2 mt-2': item.divider }"
              >
                <button
                  *ngIf="!item.divider"
                  type="button"
      ...
      <div class="flex-1 flex flex-col min-w-0">
        ...
        >
          ...
          <div class="flex items-center">
            ...
            <!-- Page Title -->
            <h1 *ngIf="pageTitle && !headerLeftTemplate" class="text-lg font-semibold text-neutral-800">
              {{ pageTitle }}
            </h1>
          </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <div *ngIf="!headerRightTemplate && currentUser" class="flex items-center space-x-3">
        ...
        <!-- Footer -->
        <footer *ngIf="footerTemplate" class="bg-white border-t border-neutral-200">
          <ng-container *ngTemplateOutlet="footerTemplate"></ng-container>
        </footer>
      </div>
    </div>
  `,
  imports: [NgClass, NgIf, NgTemplateOutlet, ButtonComponent, ButtonComponent, AvatarComponent, NgForOf],
})
